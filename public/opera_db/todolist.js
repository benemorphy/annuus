...
displaytasks = function (database) {
    ...
    var transaction, objectstore, index, request, docfrag = document.createDocumentFragment(); // ??what is document Fragment?
	// 当要向document.body添加大量数据时，如果逐个添加这些节点，这个过程有可能会十分缓慢。
